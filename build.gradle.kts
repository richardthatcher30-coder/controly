// Root build file.
//
// All Android/Kotlin/Hilt/Compose *configuration* lives in build-logic/convention
...
// resolve the real AGP/Kotlin/KSP/Hilt plugin artifacts once at the root, so
